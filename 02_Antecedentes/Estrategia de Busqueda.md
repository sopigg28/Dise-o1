...
- Guías de rehabilitación post-fractura de miembro inferior (basadas en PEDro y Cochrane)
- Escalas funcionales validadas (KOOS, LEFS — a través de Rehabilitation Measures Database)

## Definición por bloques de lo investigado

**Bloque 1:** Accidentes de tránsito con implicaciones en los miembros inferiores.  
**Bloque 2:** Afectaciones a la salud por diferencia del tamaño de los miembros inferiores.  
...
**Español:** rango de flexión de rodilla, rigidez de rodilla, arto fibrosis (corregir: artrofibrosis), actividades de la vida diaria, limitación funcional, rehabilitación de rodilla

**-Normativas y guías clínicas (transversales)**
