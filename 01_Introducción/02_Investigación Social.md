...
| Usuario Secundario | Juan David Ayala (Esposo \- familiar) | Apoyo diario en necesidades básicas y desplazamientos, situaciones que ameriten agacharse y apoyo emocional. | Asume una dependencia mínima pero real al realizar acciones que requieren agacharse, funciones que la usuaria primaria no puede ejecutar por la limitación de flexión de rodilla, además de un rol de apoyo emocional de gran importancia. |
